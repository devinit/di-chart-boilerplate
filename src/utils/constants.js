...
export const CHANNEL_VALUE_FIELD = 'usd_disbursement_deflated_Sum';
export const AIDTYPE_VALUE_FIELD = 'usd_disbursement_deflated_Sum';
export const AIDTYPE_PURPOSE_FIELD = 'aid_type_di_name';
export const YEARS = [2010, 2019];
